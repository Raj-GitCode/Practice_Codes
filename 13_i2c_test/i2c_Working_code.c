...
int main(void)
{
    ...
    StrLCD("Hello World");
	delay_s(1);
	i2c_eeprom_pagewrite(AT24C256_ADDR,EEPROM_START,(u8*)"987654321",8);
	delay_ms(10);
	CmdLCD(0x01);
	StrLCD("Writing Completed...");
	delay_s(1);
	i2c_eeprom_sequentialread(AT24C256_ADDR,EEPROM_START,eeprom_buf,8);
    eeprom_buf[8] = '\0';
	CmdLCD(0x01);
	StrLCD("Reading Complted..");
	delay_s(1);
	CmdLCD(0x01);
	StrLCD("EEPROM:");
	CmdLCD(0xc0);
